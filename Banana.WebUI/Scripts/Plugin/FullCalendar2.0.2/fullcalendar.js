...
* 修 改 人：Star.Qin
* 修改时间：2014-08-10
* 修改内容：1.添加 dayDblClick,eventDblClick两个事件，参数和dayClick、eventClick相同 2.修改英文标题为汉字
* ************************************
 */


// 马祥龙  2014/11/24  扩展一个右键点击功能 mousedown
	...
	function eventElementHandlers(event, eventElement) {
	    eventElement
		    ...
		    .mousedown(
                function (ev) {
                    if (3 == ev.which) {
                        trigger('eventMouseTwo', this, event, ev);
                    }
                }
            );
